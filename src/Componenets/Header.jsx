...
const Header = () => {
  return (
    <div className='flex flex-col items-center justify-center text-white mt-20'>
        <h4 className= 'border border-[#222222] bg-[#0A0A0A] my-2 px-3 py-1 rounded-2xl '>Powering Developers & Marketers with Fast SEO Insights</h4>
        <h1 className="text-[60px] font-outfit font-bold flex flex-col items-center leading-tight">
          <span>Run Smart & <span className="text-orange-400">Beautiful</span></span>
